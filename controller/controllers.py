...
from events.events import TickEvent, SwapGemsRequest, QuitEvent, StateEvent
...
class NaiveAIControllerV1(AbstractController):
    """
...
class CPUSpinnerController(AbstractController):
    """..."""
